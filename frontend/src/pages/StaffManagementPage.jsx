...
// // ── Create Staff Form inside Modal ───────────────────
...
//   return (
//     <Modal isOpen={isOpen} onClose={onClose} title="Add New Staff Member" size="sm">
...
//           <span>Staff will be able to create orders and update statuses. They won't see revenue data.</span>
//         </div>
...
//           💡 Share the email and password with your staff member so they can login at <span className="text-gold-400">/login</span>
//         </p>
...
//     if (window.confirm(`Remove ${staff.name}'s account? This cannot be undone.`)) {
...
//             Create and manage staff accounts. Only admins can do this.
//           </p>
//         </div>
...
//       {/* How staff logs in — info box */}
//       <div className="mb-6 glass-card p-5 border border-blue-400/20 bg-blue-400/5">
//         <h3 className="font-display font-semibold text-base text-cream-100 mb-2 flex items-center gap-2">
//           <Shield size={16} className="text-blue-400" /> How Staff Members Login
//         </h3>
//         <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-gray-400">
//           <div className="flex items-start gap-2">
//             <span className="text-gold-400 font-mono text-xs mt-0.5">01</span>
//             <span>You create their account here with email + password</span>
//           </div>
//           <div className="flex items-start gap-2">
//             <span className="text-gold-400 font-mono text-xs mt-0.5">02</span>
//             <span>Share the credentials with them (email + password)</span>
//           </div>
//           <div className="flex items-start gap-2">
//             <span className="text-gold-400 font-mono text-xs mt-0.5">03</span>
//             <span>They go to <span className="text-gold-400 font-mono">/login</span> and enter email + password</span>
//           </div>
//         </div>
//       </div>
...
//         <CardHeader
//           title="Staff Members"
//           subtitle={`${staffList.length} staff account${staffList.length !== 1 ? 's' : ''}`}
//         />
...
//             </div>
//             <p className="font-display text-gray-500 text-base">No staff yet</p>
//             <p className="text-gray-700 text-sm mt-1">Click "Add Staff" to create the first account</p>
//           </div>
//         ) : (
...
//                 {staffList.map((staff) => (
//                   <tr key={staff._id} className="hover:bg-white/3 transition-colors">
//                     {/* Name */}
//                     <td className="py-4 pr-4">
//                       <div className="flex items-center gap-2.5">
//                         <div className="w-8 h-8 rounded-full bg-blue-400/20 border border-blue-400/30 flex items-center justify-center flex-shrink-0">
//                           <span className="text-blue-400 text-xs font-bold">
//                             {staff.name[0].toUpperCase()}
//                           </span>
//                         </div>
//                         <span className="font-medium text-cream-100">{staff.name}</span>
//                       </div>
//                     </td>
...
//                     <td className="py-4 pr-4">
//                       {staff.isActive ? (
//                         <span className="inline-flex items-center gap-1.5 text-xs text-emerald-400 bg-emerald-400/10 border border-emerald-400/20 px-2.5 py-1 rounded-full font-mono">
...
//                     {/* Created date */}
//                     <td className="py-4 pr-4 text-gray-600 text-xs font-mono">
...
//                             staff.isActive
//                               ? 'text-amber-400 hover:bg-amber-400/10 border border-transparent hover:border-amber-400/20'
...
//                           className="p-2 rounded-lg text-gray-600 hover:text-rose-400 hover:bg-rose-400/10 border border-transparent hover:border-rose-400/20 transition-all"
//                         >
//                           <Trash2 size={13} />
//                         </button>
//                       </div>
